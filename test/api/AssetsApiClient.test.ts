...
describe('AssetsApiClient', () => {
  ...
  describe('downloadAsset', () => {
    ...
    it('should call getRequest with the correct path', async () => {
      ...
      expect(mockHttpClient.getRequest).toHaveBeenCalledWith(`assets/${assetDomain}/${assetId}`, {
        additionalHeaders: {}
      })
    })
  ...
  describe('uploadAsset', () => {
    ...
    it('should call postRequest with the correct base path', async () => {
      ...
      expect(mockHttpClient.postRequest).toHaveBeenCalledWith('assets', expect.anything(), expect.anything())
    })
    ...
    it('should call postRequest with multipart/mixed content type using the generated boundary', async () => {
      ...
      expect(mockHttpClient.postRequest).toHaveBeenCalledWith(expect.anything(), expect.anything(), {
