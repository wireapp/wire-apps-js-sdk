...
export class EventRouter {
  ...
  constructor(@injectAll(EVENT_PROCESSOR) processors: EventProcessor<EventContentDTO>[]) {
    this.processorMap = new Map(processors.map((processor) => [processor.eventType, processor]))
  }
