...
export class ConversationsApiClient {
  ...
  async updateConversationMemberRole(
    ...
    this.logger.debug(
      `Updating conversation member role. conversationId: ${obfuscateId(conversationId.id)}, userId: ${obfuscateId(userId.id)}, newRole: ${newRole}`
    )
    ...
    this.logger.debug(
      `Updated conversation member role. conversationId: ${obfuscateId(conversationId.id)}, userId: ${obfuscateId(userId.id)}, newRole: ${newRole}`
    )
  }
